...
const SUBCATEGORIES: Record<string, string> = {
  datacleaning: "Data Preparation: Cleaning",
  datatransformation: "Data Preparation: Transformation",
  datarestructuring: "Data Preparation: Restructuring",
  datacreation: "Data Preparation: Creating",
};
...
export default async function DataPreparationSubPage({
  params,
}: {
  ...
  const posts = sortByOrdinal(
    getAllPosts().filter(
      (p) =>
        p.category?.toLowerCase() === "datapreparation" &&
